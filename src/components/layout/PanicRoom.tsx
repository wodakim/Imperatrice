...
export default function PanicRoom() {
  ...
  if (typeof window !== 'undefined') {
    window.addEventListener('triggerPanic', () => setIsVisible(true));
  }
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center text-center p-5 bg-gradient-to-br from-[#a8c0ff] to-[#3f2b96] text-white">
        ...
        <div className="bg-white/20 p-6 rounded-2xl mb-8 backdrop-blur-md text-left">
